...
AND MEMBER_EMAIL = 'user0122@kh.or.kr';
...
-- 12/15일 오전 10시 수행
SELECT SYSDATE - TO_DATE('2025-12-14 12:27:00', 'YYYY-MM-DD HH24:MI:SS')
FROM DUAL;
...
SELECT CHATTING_ROOM_NO
	...
	,NVL2((SELECT OPEN_MEMBER FROM CHATTING_ROOM R2
		...
		AND R2.OPEN_MEMBER = 2), -- 값
		R.PARTICIPANT, -- NULL이 아닌경우
	...
	AND READ_FL = 'N' AND SENDER_NO != 2) NOT_READ_COUNT
...
-- 채팅방번호 체크 
SELECT NVL(MAX(CHATTING_ROOM_NO), 0) CHATTING_ROOM_NO
FROM CHATTING_ROOM
